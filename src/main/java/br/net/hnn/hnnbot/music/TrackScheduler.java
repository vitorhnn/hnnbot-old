...
public class TrackScheduler extends AudioEventAdapter {
    ...
    public void queue(AudioTrack track) {
        ...
        // something is playing, it returns false and does nothing. In that
        // case the player was already playing so this
    ...
    public void nextTrack() {
        // Start the next track, regardless of if something is already
        // playing or not. In case queue was empty, we are
        // giving null to startTrack, which is a valid argument and will
